			...
			<div className="col-4">
			    ...
			    <div className="bio p-2 border-start">
				    <h5 className='ps-2'>Contacts</h5>
				       <p className='font-monospace text-start'><i className="fa-solid fa-phone"></i> <span>+880123456789</span> </p>
				       <p className='font-monospace text-start'><i className="fa-solid fa-envelope"></i> <span>sdfa@gmail.com</span> </p>
				       <p className='font-monospace text-start'><i className="fa-brands fa-github"></i> <span>sdfdsf</span> </p>
			    </div>
			    <div className="bio p-2 border-start">
